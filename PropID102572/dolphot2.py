...
class DolphotParameters(object):
    ...
    def __init__(self, psfA=(3, 0, 0, 0, 0, 0),
            ...
            PSFPhot=1,PSFPhotIt=2, FitSky=2, SkipSky=2, SkySig=2.25,
            ...
            Force1=1,
            EPSF=1,
            ACSuseCTE =0,CombineChi =1,ACSpsfType = 0, InterpPSFlib = 1,
            PSFsol=0, PSFres=1, psfstars=None, psfoff=0.0,
            ApCor=1, SubPixel=1,
            FakeStars=None, FakeMatch=3., FakeStarPSF=0, FakePSF=1.5,
            RandomFake=1,
            xytfile=None, xytpsf=None, photsec=None,FlagMask=4):
        ...
        self.params = {"img_psfa": psfA, "img_psfb": psfB,
                ...
                "img_RPSF": RPSF,
            "PSFPhot": PSFPhot, 'PSFPhotIt': PSFPhotIt,"FitSky": FitSky,
            "SkipSky": SkipSky,
            ...
            "Force1": Force1, "EPSF": EPSF,'ACSuseCTE': ACSuseCTE ,'CombineChi': CombineChi,'ACSpsfType':ACSpsfType,
            "InterpPSFlib":InterpPSFlib, 
            "PSFsol": PSFsol,
            ...
            "xytfile": xytfile, "xytpsf": xytpsf, "photsec": photsec,"FlagMask":FlagMask}
